<%@ Page Title="Список ВЛ Дзержинский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="DergBalancePoVL.aspx.cs" Inherits="Sbyt.DergBalancePoVL" %>
...
<asp:GridView runat="server" ID="ListVLs" 
    ...
    <Columns>
        ...
        HeaderText="Список ВЛ" 
            ...
            DataNavigateUrlFormatString="~/DergOplatiPoVL.aspx?DOC_CODE={0}&DOC_NAME_VL10={1}" 
            Target="_blank"  >
...
<asp:ObjectDataSource runat="server" ID="VLsObjectDatasource"   
                      ...
                      TypeName="Sbyt.Balance_Po_VL.DergBLLVLs" 
                      SelectMethod="GetVLs" 
