<%@ Page Title="Оплаты по ВЛ Столбцовский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="StolbOplatiPoVL.aspx.cs" Inherits="Sbyt.StolbOplatiPoVL" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<h2 style="color:Navy; text-align:center">Оплаты по ВЛ Столбцовский РЭС:</h2>  
