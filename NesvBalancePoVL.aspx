<%@ Page Title="Список ВЛ Несвижский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="NesvBalancePoVL.aspx.cs" Inherits="Sbyt.NesvBalancePoVL" %>
...
<asp:GridView runat="server" ID="ListVLs" 
    ...
    <Columns>
        ...
        HeaderText="Список ВЛ" 
            ...
            DataNavigateUrlFormatString="~/NesvOplatiPoVL.aspx?DOC_CODE={0}&DOC_NAME_VL10={1}" 
            Target="_blank"  >
...
<asp:ObjectDataSource runat="server" ID="VLsObjectDatasource"   
                      ...
                      TypeName="Sbyt.Balance_Po_VL.NesvBLLVLs" 
                      SelectMethod="GetVLs" 
