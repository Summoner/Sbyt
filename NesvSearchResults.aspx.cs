...
namespace Sbyt
{
    public partial class NesvSearchResults : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (PromTableNames.Count != 0)
            {
                ...
                // promTable = Balance_Po_VL.OracleOplati.Instance.PromGetOraTable(Promsql, ConfigurationHelper.NesvOraConnectionStringBalPoTP, "Узденский РЭС");
                promTable = App_Service.SearchOra.Instance.PromGetOraTable(PromTableNames, searchExpression, ConfigurationHelper.NesvOraConnectionStringBalPoTP, "Несвижский РЭС");
            ...
            if (BytTableNames.Count != 0)
            {
                ...
                //   bytTable = Balance_Po_VL.OracleOplati.Instance.BytGetOraTable(Bytsql, ConfigurationHelper.NesvOraConnectionStringBalPoTP, "Узденский РЭС");
                bytTable = App_Service.SearchOra.Instance.BytGetOraTable(BytTableNames, searchExpression, ConfigurationHelper.NesvOraConnectionStringBalPoTP, "Несвижский РЭС");
