<%@ Page Title="Результаты поиска" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="NesvSearchResults.aspx.cs" Inherits="Sbyt.NesvSearchResults" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

<h2 style="color:Navy; text-align:center">Результаты поиска по Несвижскому РЭС:</h2>  
