<%@ Page Title="Оплаты по ВЛ Дзержинский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="DergOplatiPoVL.aspx.cs" Inherits="Sbyt.DergOplatiPoVL" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<h2 style="color:Navy; text-align:center">Оплаты по ВЛ Дзержинский РЭС:</h2>  
