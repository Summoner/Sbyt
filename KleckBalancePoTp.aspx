<%@ Page Title="Клецкий РЭС оплаты" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="KleckBalancePoTp.aspx.cs" Inherits="Sbyt.ContactUs" %>
...
<asp:GridView runat="server" ID="ListTPs" 
    ...
    <Columns>
        ...
        HeaderText="Список ТП" 
            ...
            DataNavigateUrlFormatString="~/KleckOplatiPoTp.aspx?DOC_CODE={0}&DOC_NAME={1}" 
            Target="_blank"  >
