<%@ Page Title="Оплаты по ВЛ Узденский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="UzdaOplatiPoVL.aspx.cs" Inherits="Sbyt.UzdaOplatiPoVL" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


<h2 style="color:Navy; text-align:center">Оплаты по ВЛ Узденский РЭС:</h2>  
