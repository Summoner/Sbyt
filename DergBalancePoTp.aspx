<%@ Page Title="Дзержинский РЭС оплаты" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="DergBalancePoTp.aspx.cs" Inherits="Sbyt.DergBalancePoTp" %>
...
<asp:GridView runat="server" ID="ListTPs" 
    ...
    <Columns>
        ...
        HeaderText="Список ТП" 
            ...
            DataNavigateUrlFormatString="~/DergOplatiPoTp.aspx?DOC_CODE={0}&DOC_NAME={1}" 
            Target="_blank"  >
...
<asp:ObjectDataSource runat="server" ID="TPsObjectDatasource"   
                      ...
                      TypeName="Sbyt.Balance_Po_TP.DergBLLTPs" 
                      SelectMethod="GetTPs" 
