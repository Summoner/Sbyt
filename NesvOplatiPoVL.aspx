<%@ Page Title="Оплаты по ВЛ Несвижский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="NesvOplatiPoVL.aspx.cs" Inherits="Sbyt.NesvOplatiPoVL" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

<h2 style="color:Navy; text-align:center">Оплаты по ВЛ Несвижский РЭС:</h2>  
