<%@ Page Title="Оплаты Столбцовский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="StolbOplatiPoTp.aspx.cs" Inherits="Sbyt.StolbOplatiReportNew" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<h2 style="color:Navy; text-align:center">Оплаты по ТП Столбцовский РЭС:</h2>  
