<%@ Page Title="Результаты поиска" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="UzdaSearchResults.aspx.cs" Inherits="Sbyt.SearchResults" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


<h2 style="color:Navy; text-align:center">Результаты поиска по Узденскому РЭС:</h2>  
