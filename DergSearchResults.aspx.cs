...
namespace Sbyt
{
    public partial class DergSearchResults : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (PromTableNames.Count != 0)
            {
                ...
                // promTable = Balance_Po_VL.OracleOplati.Instance.PromGetOraTable(Promsql, ConfigurationHelper.DergOraConnectionStringBalPoTP, "Узденский РЭС");
                promTable = App_Service.SearchOra.Instance.PromGetOraTable(PromTableNames, searchExpression, ConfigurationHelper.DergOraConnectionStringBalPoTP, "Дзержинский РЭС");
            ...
            if (BytTableNames.Count != 0)
            {
                ...
                //   bytTable = Balance_Po_VL.OracleOplati.Instance.BytGetOraTable(Bytsql, ConfigurationHelper.DergOraConnectionStringBalPoTP, "Узденский РЭС");
                bytTable = App_Service.SearchOra.Instance.BytGetOraTable(BytTableNames, searchExpression, ConfigurationHelper.DergOraConnectionStringBalPoTP, "Дзержинский РЭС");
