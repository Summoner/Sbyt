...
{
    public class DergOracleTpProvider : BaseDal
    {
        ...
        #region Instance
        private DergOracleTpProvider() { }

        [ThreadStatic]
        private static DergOracleTpProvider _instance;

        public static DergOracleTpProvider Instance
        {
            get { return _instance ?? (_instance = new DergOracleTpProvider()); }
        }
        #endregion
        ...
        {
            using (OracleConnection connection = new OracleConnection(ConfigurationHelper.DergOraConnectionStringBalPoTP))
            {
