...
{
    public class StolbOracleTpProvider : BaseDal
    {
        ...
        #region Instance
        private StolbOracleTpProvider() { }

        [ThreadStatic]
        private static StolbOracleTpProvider _instance;

        public static StolbOracleTpProvider Instance
        {
            get { return _instance ?? (_instance = new StolbOracleTpProvider()); }
        }
        #endregion
        ...
        {
            using (OracleConnection connection = new OracleConnection(ConfigurationHelper.StolbPassportConnectionString))
            {
                if (TPsSort == "")
                {
                    TPsSort = "DOC_NAME";
        ...
        {
            using (OracleConnection connect = new OracleConnection(ConfigurationHelper.StolbPassportConnectionString))
            {
        ...
        {
            using (OracleConnection connection = new OracleConnection(ConfigurationHelper.StolbOraConnectionStringBalPoTP))
            {
