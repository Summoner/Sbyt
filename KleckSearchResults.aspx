<%@ Page Title="Результаты поиска" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="KleckSearchResults.aspx.cs" Inherits="Sbyt.KleckSearchResults" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

<h2 style="color:Navy; text-align:center">Результаты поиска по Клецкому РЭС:</h2>  
