...
namespace Sbyt
{
    public partial class StolbBalancePoVL : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            testLabel.Text = "Список ВЛ Столбцовского РЭС";
        ...
        {
            ListVLs.Visible = false;
            SearchVL.Visible = true;
        ...
        protected void VLsSearchObjectDataSource_Selecting(object sender, ObjectDataSourceSelectingEventArgs e)
        {
