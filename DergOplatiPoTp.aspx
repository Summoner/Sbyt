<%@ Page Title="Оплаты Дзержинский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="DergOplatiPoTp.aspx.cs" Inherits="Sbyt.DergOplatiPoTP" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2 style="color:Navy; text-align:center">Оплаты по ТП Дзержинского РЭС:</h2>  
