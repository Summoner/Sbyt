<%@ Page Title="Список ВЛ Столбцовский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="StolbBalancePoVL.aspx.cs" Inherits="Sbyt.StolbBalancePoVL" %>
...
<asp:Button runat="server" ID="buttonsearch" Cssclass="buttonsearch"  Text="Искать ВЛ!" OnClick="SearchButton_Click" />
</div>
 <div id="TPLIST">
<table >
  <tr>
    <td>
<asp:GridView runat="server" ID="ListVLs" 
              DataSourceID="VLsObjectDatasource"
              AllowPaging="True" 
              PageSize="16" 
              AllowSorting="True"
              ...
              ForeColor="#333333" 
              GridLines="None" Height="552px">
    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
    <Columns>
        <asp:BoundField DataField="DOC_CODE" Visible="false"   HeaderText="Список кодов ВЛ" 
            SortExpression="DOC_CODE" >
        <ControlStyle Font-Size="Large" Font-Bold="True" />
        </asp:BoundField>
    </Columns>
    <Columns>
        <asp:hyperlinkfield DataTextField="DOC_NAME_VL10"   
        HeaderText="Список ВЛ" 
            SortExpression="DOC_NAME_VL10"
            DataNavigateUrlFields="DOC_CODE,DOC_NAME_VL10"
            DataNavigateUrlFormatString="~/StolbOplatiPoVL.aspx?DOC_CODE={0}&DOC_NAME_VL10={1}" 
            Target="_blank"  >
    ...
    <Columns>
        <asp:BoundField DataField="BEG_NAME" HeaderText="Линия" 
            SortExpression="BEG_NAME" >
        <ControlStyle Font-Size="Large" Font-Bold="True" />
        </asp:BoundField>
    </Columns>
...
<asp:GridView runat="server" ID="SearchVL" 
              DataSourceID="VLsSearchObjectDatasource"
              AllowPaging="True" 
              PageSize="16" 
              AllowSorting="True"
              AutoGenerateColumns="False" 
...
<asp:ObjectDataSource runat="server" ID="VLsObjectDatasource"   
                      SortParameterName="VLsSort" 
                      TypeName="Sbyt.Balance_Po_VL.StolbBLLVLs" 
                      SelectMethod="GetVLs" 
                      SelectCountMethod="GetVLsCount"  
                      EnablePaging="true"></asp:ObjectDataSource>

                      <asp:ObjectDataSource runat="server" ID="VLsSearchObjectDatasource"   
                       
                      TypeName="Sbyt.Balance_Po_VL.StolbBLLVLs" 
                      SelectMethod="GetVLbyName" 
                      
                     
                      OnSelecting="VLsSearchObjectDataSource_Selecting" >
                      <SelectParameters>
