...
namespace Sbyt
{
    public partial class StolbSearchResults : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (PromTableNames.Count != 0)
            {
                ...
                // promTable = Balance_Po_VL.OracleOplati.Instance.PromGetOraTable(Promsql, ConfigurationHelper.StolbOraConnectionStringBalPoTP, "Узденский РЭС");
                promTable = App_Service.SearchOra.Instance.PromGetOraTable(PromTableNames, searchExpression, ConfigurationHelper.StolbOraConnectionStringBalPoTP, "Столбцовский РЭС");
            ...
            if (BytTableNames.Count != 0)
            {
                ...
                //   bytTable = Balance_Po_VL.OracleOplati.Instance.BytGetOraTable(Bytsql, ConfigurationHelper.StolbOraConnectionStringBalPoTP, "Узденский РЭС");
                bytTable = App_Service.SearchOra.Instance.BytGetOraTable(BytTableNames, searchExpression, ConfigurationHelper.StolbOraConnectionStringBalPoTP, "Столбцовский РЭС");
