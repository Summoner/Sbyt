<%@ Page Title="Список ВЛ Узденский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="UzdaBalancePoVL.aspx.cs" Inherits="Sbyt.UzdaBalancePoVL" %>
...
<asp:GridView runat="server" ID="ListVLs" 
    ...
    <Columns>
        ...
        HeaderText="Список ВЛ" 
            ...
            DataNavigateUrlFormatString="~/UzdaOplatiPoVL.aspx?DOC_CODE={0}&DOC_NAME_VL10={1}" 
            Target="_blank"  >
...
<asp:ObjectDataSource runat="server" ID="VLsObjectDatasource"   
                      ...
                      TypeName="Sbyt.Balance_Po_VL.UzdaBLLVLs" 
                      SelectMethod="GetVLs" 
