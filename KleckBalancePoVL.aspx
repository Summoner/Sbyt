<%@ Page Title="Список ВЛ Клецкий РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="KleckBalancePoVL.aspx.cs" Inherits="Sbyt.KleckBalancePoVL" %>
...
<asp:GridView runat="server" ID="ListVLs" 
    ...
    <Columns>
        ...
        HeaderText="Список ВЛ" 
            ...
            DataNavigateUrlFormatString="~/KleckOplatiPoVL.aspx?DOC_CODE={0}&DOC_NAME_VL10={1}" 
            Target="_blank"  >
...
<asp:ObjectDataSource runat="server" ID="VLsObjectDatasource"   
                      ...
                      TypeName="Sbyt.Balance_Po_VL.KleckBLLVLs" 
                      SelectMethod="GetVLs" 
