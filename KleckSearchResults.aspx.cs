...
namespace Sbyt
{
    public partial class KleckSearchResults : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (PromTableNames.Count != 0)
            {
                ...
                // promTable = Balance_Po_VL.OracleOplati.Instance.PromGetOraTable(Promsql, ConfigurationHelper.KleckOraConnectionStringBalPoTP, "Узденский РЭС");
                promTable = App_Service.SearchOra.Instance.PromGetOraTable(PromTableNames, searchExpression, ConfigurationHelper.KleckOraConnectionStringBalPoTP, "Клецкий РЭС");
            ...
            if (BytTableNames.Count != 0)
            {
                ...
                //   bytTable = Balance_Po_VL.OracleOplati.Instance.BytGetOraTable(Bytsql, ConfigurationHelper.KleckOraConnectionStringBalPoTP, "Узденский РЭС");
                bytTable = App_Service.SearchOra.Instance.BytGetOraTable(BytTableNames, searchExpression, ConfigurationHelper.KleckOraConnectionStringBalPoTP, "Клецкий РЭС");
