...
namespace Sbyt
{
    public partial class DergBalancePoTp : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            testLabel.Text = "Список ТП Дзержинского РЭС";
        ...
        {
          //  Session["searchExpression"] = search.Text;
          //  Response.Write("<script>window.open('DergSearchResults.aspx', '_blank')</script>");
  ...
  {
      string VLName = search.Text;// method to get a tp name
    ...
    e.InputParameters.Add("DOC_NAME", VLName);
