<%@ Page Title="Узденский РЭС оплаты" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="UzdaBalancePoTp.aspx.cs" Inherits="Sbyt.UzdaBalancePoTp" %>
...
<asp:GridView runat="server" ID="ListTPs" 
    ...
    <Columns>
        ...
        HeaderText="Список ТП" 
            ...
            DataNavigateUrlFormatString="~/UzdaOplatiPoTp.aspx?DOC_CODE={0}&DOC_NAME={1}" 
            Target="_blank"  >
...
<asp:ObjectDataSource runat="server" ID="TPsObjectDatasource"   
                      ...
                      TypeName="Sbyt.Balance_Po_TP.UzdaBLLTPs" 
                      SelectMethod="GetTPs" 
