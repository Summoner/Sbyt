<%@ Page Title="Оплаты Несвижский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="NesvOplatiPoTp.aspx.cs" Inherits="Sbyt.NesvOplatiReportNew" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

<h2 style="color:Navy; text-align:center">Оплаты по ТП Несвижского РЭС:</h2>  
