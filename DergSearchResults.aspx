<%@ Page Title="Результаты поиска" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="DergSearchResults.aspx.cs" Inherits="Sbyt.DergSearchResults" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

<h2 style="color:Navy; text-align:center">Результаты поиска по Дзержинскому РЭС:</h2>  
