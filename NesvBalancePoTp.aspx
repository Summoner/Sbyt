<%@ Page Title="Несвижский РЭС оплаты" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="NesvBalancePoTp.aspx.cs" Inherits="Sbyt.NesvBalancePoTp" %>
...
<asp:GridView runat="server" ID="ListTPs" 
    ...
    <Columns>
        ...
        HeaderText="Список ТП" 
            ...
            DataNavigateUrlFormatString="~/NesvOplatiPoTp.aspx?DOC_CODE={0}&DOC_NAME={1}" 
            Target="_blank"  >
...
<asp:ObjectDataSource runat="server" ID="TPsObjectDatasource"   
                      ...
                      TypeName="Sbyt.Balance_Po_TP.NesvBLLTPs" 
                      SelectMethod="GetTPs" 
