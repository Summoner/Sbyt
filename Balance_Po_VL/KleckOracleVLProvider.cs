...
{
    public class KleckOracleVLProvider : BaseDal
    {
        ...
        #region Instance
        private KleckOracleVLProvider() { }

        [ThreadStatic]
        private static KleckOracleVLProvider _instance;

        public static KleckOracleVLProvider Instance
        {
            get { return _instance ?? (_instance = new KleckOracleVLProvider()); }
        }
        #endregion
