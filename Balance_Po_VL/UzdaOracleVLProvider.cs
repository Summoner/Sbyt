...
{
    public class UzdaOracleVLProvider : BaseDal
    {
        ...
        #region Instance
        private UzdaOracleVLProvider() { }

        [ThreadStatic]
        private static UzdaOracleVLProvider _instance;

        public static UzdaOracleVLProvider Instance
        {
            get { return _instance ?? (_instance = new UzdaOracleVLProvider()); }
        }
        #endregion
