...
{
    public class StolbOracleVLProvider:BaseDal
    {
        ...
        #region Instance
        private StolbOracleVLProvider() { }

        [ThreadStatic]
        private static StolbOracleVLProvider _instance;

        public static StolbOracleVLProvider Instance
        {
            get { return _instance ?? (_instance = new StolbOracleVLProvider()); }
        }
        #endregion
