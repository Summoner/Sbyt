...
{
    public class NesvOracleVLProvider :BaseDal
    {

         //Описание инстанса. Он нужен для доступа к методам DAL слоя из BLL слоя
      
        #region Instance
        private NesvOracleVLProvider() { }

        [ThreadStatic]
        private static NesvOracleVLProvider _instance;

        public static NesvOracleVLProvider Instance
        {
            get { return _instance ?? (_instance = new NesvOracleVLProvider()); }
        }
        #endregion
