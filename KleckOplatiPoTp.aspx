<%@ Page Title="Оплаты Клецкий РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="KleckOplatiPoTp.aspx.cs" Inherits="Sbyt.KleckOplatiReportNew" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

<h2 style="color:Navy; text-align:center">Оплаты по ТП Клецкий РЭС:</h2>  
