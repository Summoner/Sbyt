<%@ Page Title="Оплаты Узденский РЭС" Language="C#" MasterPageFile="~/Sbyt.Master" AutoEventWireup="true" CodeBehind="UzdaOplatiPoTp.aspx.cs" Inherits="Sbyt.UzdaOplatiReportNew" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


<h2 style="color:Navy; text-align:center">Оплаты по ТП Узденского РЭС:</h2>  
