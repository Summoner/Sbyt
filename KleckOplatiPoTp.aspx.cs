...
namespace Sbyt
{
    public partial class KleckOplatiReportNew : Page
    {
      ...
      //  String bytGuid = Guid.NewGuid().ToString();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((promTableNames.Count > 0) && (promTableNames.Count <= Constants.PromBytTablesCount))
            {
               ...
               promTable = OracleOplati.Instance.GetOplatiTablePromTP(promTableNames, ConfigurationHelper.KleckOraConnectionStringBalPoTP, Request.QueryString["DOC_CODE"]);

             //   promTable =
             //   OracleOplati.Instance.PromGetOraTable(OracleOplati.Instance.FormSqlProm(promTableNames, Request.QueryString["DOC_CODE"]), ConfigurationHelper.KleckOraConnectionStringBalPoTP, Constants.KleckResLongName);
            ...
            if ((bytTableNames.Count > 0) && (bytTableNames.Count <= Constants.PromBytTablesCount))
            {
               ...
               bytTable = OracleOplati.Instance.GetOplatiTableBytTP(bytTableNames, ConfigurationHelper.KleckOraConnectionStringBalPoTP, Request.QueryString["DOC_NAME"]);
             //   bytTable =
             //  OracleOplati.Instance.BytGetOraTable(OracleOplati.Instance.FormSqlByt(bytTableNames, Request.QueryString["DOC_NAME"]), ConfigurationHelper.KleckOraConnectionStringBalPoTP, Constants.KleckResLongName);
        ...
        protected void PromHyper(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AddHeader("Content-Disposition", "attachment; filename=" + "KleckProm" + Request.QueryString["DOC_NAME"] + ".xls");
            Response.Charset = "";
        ...
        protected void BytHyper(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AddHeader("Content-Disposition", "attachment; filename=" + "KleckByt" + Request.QueryString["DOC_NAME"] + ".xls");
            Response.Charset = "";
            Response.ContentType = "application/vnd.ms-excel";
            Response.Write(sw.ToString());
            Response.Flush();
